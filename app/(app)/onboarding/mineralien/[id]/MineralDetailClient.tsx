...
import { MINERAL_ARTICLES, type AcademyTopic } from "@/src/domain/academyContent";
...
export default function MineralDetailClient({ mineralId }: { mineralId: string }) {
    const theme = useTheme();
    const mineral = mineralId ? MINERAL_ARTICLES[mineralId] : undefined;
    ...
    if (!mineral) {
        return (
            <Box sx={{ minHeight: '100vh', bgcolor: 'background.default', p: 4 }}>
                <Typography>Mineral nicht gefunden</Typography>
                <Link href="/onboarding/mineralien">Zurück zur Übersicht</Link>
            </Box>
        );
    }
    ...
    return (
        <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
            ...
            <Box sx={{
                ...
                <IconButton component={Link} href="/onboarding/mineralien" sx={{ color: 'text.secondary' }}>
            ...
            <Box sx={{ textAlign: 'center', py: 4 }}>
                <Typography sx={{ fontSize: 64, mb: 1 }}>{mineral.emoji}</Typography>
            ...
            <Box sx={{ borderTop: 1, borderColor: 'divider' }}>
                {mineral.topics.map((topic, index) => (
                    <Box
                        key={topic.id}
                        ...
                        sx={{
                            ...
                            px: 2,
                            py: 2,
                            borderBottom: index < mineral.topics.length - 1 ? 1 : 0,
                            borderColor: 'divider',
